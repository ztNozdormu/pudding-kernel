package com.mohism.pudding.kernel.model.auth.context;
...
public interface CommonConstant {
     ...
     * 限流标识
     */
    String LIMIT_ALL = "PUDDING_LIMIT_ALL";
     ...
     * 短信验证码key前缀
     */
    String PRE_SMS = "PUDDING_PRE_SMS:";

    /**
     * 邮件验证码key前缀
     */
    String PRE_EMAIL = "PUDDING_PRE_EMAIL:";
